...
<div style="text-align:justify" class="Ccontent">
    ...
    <h3>C++ is one of the world most popular programming languages.<br>
        ...
        As C++ is close to C# and Java, it makes it easy for programmers to switch to C++ or vice versa<br>
    </h3>
    <h1>C++ DATATYPES </h1>
    <h3>
        <ul  class="Clist">
    ...
    <h1>BASIC DATATYPES AND DESCRIPTION</h1>
    <table>  
    ...
    <!-- /*2 page*/ -->
    <h1>FOLLOWING OPERATORS USED IN C++</h1>
    <h3>
